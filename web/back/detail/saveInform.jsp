...
<div id="TitleArea">
	...
	<div id="TitleArea_Title">
		<div id="TitleArea_Title_Content">
			<img border="0" width="10" height="13" src="style/images/title_arrow.gif"/>  插入
		</div>
    </div>
...
<div id="MainArea">
	...
	<!---<form action="#"method="post">-->
		...
		<div class="ItemBlock_Title">
        	<img width="4" height="7" border="0" src="style/images/item_point.gif"> 信息更改&nbsp;
        </div>
		<!-- 本段表单字段 -->
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
				<div class="ItemBlock2">
					<form  action="/staff/staffAdd.action"  method="post">
